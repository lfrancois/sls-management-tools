...
extensions = sphinx_extensions + cloud_sptheme_extensions
...
htmlhelp_basename = 'CxmanagePythonAPIdoc'
...
latex_documents = [
                   (
                    'index', 'CxmanagePythonAPI.tex',
                    u'Cxmanage Python API Documentation',
                    u' ', 'manual'
                   ),
                  ]
...
man_pages = [
    ('index', 'cxmanagepythonapi', u'Cxmanage Python API Documentation',
     [u' '], 1)
]
...
texinfo_documents = [
  ('index', 'CxmanagePythonAPI', u'Cxmanage Python API Documentation',
   u' ', 'CxmanagePythonAPI', 'One line description of project.',
   'Miscellaneous'),
]
...
# End of file: cxmanage_api/docs/source/conf.py
